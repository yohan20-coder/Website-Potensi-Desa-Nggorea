<div id="mycarousel" class="carousel slide" data-ride="carousel">
	...
	<ol class="carousel-indicators">
		<?php
			$artikel = mysqli_query($koneksi,"select * from artikel where kategori = 'tenun ikat' order by id_artikel desc limit 4");
			$no=0;
	...
	<div class="carousel-inner" role="listbox">
		...
		?>
			...
			<div class="item <?php if($no==0) echo'active';?> ">
				<img src="gambar/artikel/<?= $data['gambar'];?>" class ="gambar-artikel" width="100%" height="60%";>
			</div>
			<?php 
				$no++;
				}
